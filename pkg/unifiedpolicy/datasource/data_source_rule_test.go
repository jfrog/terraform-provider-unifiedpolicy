		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(dataSourceFqrn, "created_at"),
					resource.TestCheckResourceAttrSet(dataSourceFqrn, "created_by"),
					resource.TestCheckResourceAttrSet(dataSourceFqrn, "updated_at"),
					resource.TestCheckResourceAttrSet(dataSourceFqrn, "updated_by"),
				),
			},
		},
	})
