		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(dataSourceFqrn, "templates.0.created_at"),
					resource.TestCheckResourceAttrSet(dataSourceFqrn, "templates.0.created_by"),
					resource.TestCheckResourceAttrSet(dataSourceFqrn, "templates.0.updated_at"),
					resource.TestCheckResourceAttrSet(dataSourceFqrn, "templates.0.updated_by"),
				),
			},
		},
	})
