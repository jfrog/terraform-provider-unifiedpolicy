		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(dataSourceFqrn, "rules.0.created_at"),
					resource.TestCheckResourceAttrSet(dataSourceFqrn, "rules.0.created_by"),
					resource.TestCheckResourceAttrSet(dataSourceFqrn, "rules.0.updated_at"),
					resource.TestCheckResourceAttrSet(dataSourceFqrn, "rules.0.updated_by"),
				),
			},
		},
	})
