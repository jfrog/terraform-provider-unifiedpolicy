...
func (p *UnifiedPolicyProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		// Example:
		// func() resource.Resource { return &lifecyclePolicyResource{} },
	}
}
...
func (p *UnifiedPolicyProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		// Example:
		// func() datasource.DataSource { return &lifecyclePolicyDataSource{} },
	}
}

// Framework returns a function that creates a new UnifiedPolicyProvider instance.
